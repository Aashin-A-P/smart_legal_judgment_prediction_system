...
client = OpenAI(
    ...
    api_key="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"  # 🔑 replace with your actual key
)
...
if __name__ == "__main__":
    process_dataset(
        input_path="batch_1.csv",           # input dataset (must have 'text' column)
        output_path="batch_1_cases_with_facts.csv", # output dataset
