...
client = OpenAI(
    ...
    api_key="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"  # 🔑 replace with your actual key
)
...
if __name__ == "__main__":
    process_dataset(
        input_path="batch_2.csv",           # input dataset (must have 'text' column)
        output_path="batch_2_cases_with_facts.csv", # output dataset
